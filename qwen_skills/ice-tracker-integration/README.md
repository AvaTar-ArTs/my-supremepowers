...
This integration provides specialized assistance for the ICE Tracker project, including development guidance, Git AI integration help, and project-specific knowledge.

## Components

### Skills
- **ICE Tracker Assistant Skill** (skills/ice-tracker-integration/SKILL.md): A specialized skill that provides assistance with the ICE Tracker project, including development guidance, Git AI integration help, and project-specific knowledge.

### Agents
- **ICE Tracker Assistant Agent** (agents/ice-tracker-assistant/agent.md): An advanced agent designed to provide comprehensive assistance with the ICE Tracker project, combining knowledge of the project's architecture, Git AI integration, and development workflows.
