...
> **Gemini/Supremepower adapter:** Propagated from canonical superpowers at `~/iterm2/superpowers/skills/using-superpowers/` and adapted for Gemini/Supremepower extension loading.
